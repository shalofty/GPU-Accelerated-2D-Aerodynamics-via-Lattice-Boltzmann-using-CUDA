#!/usr/bin/env python3
"""
CPU Performance Profiling Script

This script runs CPU LBM simulations and collects performance metrics.
"""
...
def run_cpu_simulation(config_path: str, output_dir: str) -> Dict:
    """Run CPU simulation and collect metrics."""
    print(f"Running CPU simulation with config: {config_path}")
...
def profile_grid_sizes() -> List[Dict]:
    ...
    for nx, ny in grid_sizes:
        ...
        metrics = run_cpu_simulation(config_path, output_dir)
        if metrics:
...
def main():
    ...
    output_file = "cpu_profile_results.json"
    
    print("CPU Performance Profiling")
    print("=" * 50)
